...
1. ### 🔗 **[prezenterium.pl](https://prezenterium.pl/)** (ok. 900 wejść / 28 dni)
    ...
    * **Front-End (HTML/CSS)**: nadpisywanie stylów i dostosowywanie wizualne motywu WordPressa do własnych potrzeb.

    * **Back-End (PHP)**: dostosowanie mechanizmów systemu zarządzania produktami pod kątem działania mojej automatyzacji.
...
2. ### 🔗 **[panstwa-miasta.com.pl](https://panstwa-miasta.com.pl/)** (ok. 8000 wejść / 28 dni)
    ...
    * **Zarządzanie treścią:** bieżąca obsługa CMS WordPress, formatowanie, strukturyzacja (nagłówki, linkowanie) oraz publikacja nowych podstron i wpisów.
    * **SEO:** prowadzenie analizy słów kluczowych oraz optymalizacja wpisów pod kątem wytycznych wyszukiwarek, co aktywnie wspiera utrzymanie wysokiego ruchu na stronie.
    * **Wyszukiwanie treści:** zbieranie, weryfikacja i opracowywanie informacji na potrzeby rozbudowy architektury strony o nowe działy tematyczne.
